        ...
        <div className="relative">
          ...
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-2 mb-3">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-terracotta-500 to-terracotta-600 flex items-center justify-center shadow-lg shadow-terracotta-500/25">
                <span className="text-white font-bold text-2xl">B</span>
              </div>
            </div>
            <h1 className="text-2xl font-bold text-warmBeige-100">Create Account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className={currentStep === 1 ? 'block' : 'hidden'}>
              ...
              <div>
                <label className="text-sm font-medium text-warmBeige-200 mb-1 block">
                  Account Type
                </label>
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    `}
                  >
                    <FiUserCheck className={`mx-auto mb-1 ${formData.role === 'reader' ? 'text-terracotta-400' : 'text-warmBeige-400'}`} size={20} />
                  ...
                  <button
                    ...
                    `}
                  >
                    <FiBriefcase className={`mx-auto mb-1 ${formData.role === 'publisher' ? 'text-terracotta-400' : 'text-warmBeige-400'}`} size={20} />
